...
<template>
  <div class="max-w-3xl mx-auto">
    ...
    <!-- 輸入區 -->
    <div
      class="rounded-lg border border-paper-300 dark:border-paper-700 bg-paper-50 dark:bg-ink-800 p-6 mb-8"
    >
      <div class="grid grid-cols-1 sm:grid-cols-2 gap-4 mb-4">
        <!-- 日期輸入 -->
        <div class="flex flex-col gap-1">
          <label for="bazi-date" class="text-sm text-ink-500 dark:text-paper-400">
            {{ t('bazi.dateLabel') }}
          </label>
          <input
            id="bazi-date"
        ...
        <!-- 時辰輸入 -->
        <div class="flex flex-col gap-1">
          <label for="bazi-hour" class="text-sm text-ink-500 dark:text-paper-400">
            {{ t('bazi.timeLabel') }}
          </label>
          <input
            id="bazi-hour"
    ...
    >
      ...
      <!-- 全天十三時辰 -->
      <div>
        <p class="text-xs text-ink-400 dark:text-paper-500 mb-2 tracking-widest">全天十三時辰</p>
